<div class="obr-page">
	<h1 class="obr_title">Информация о плагине "Сведения об образовательной организации"</h2>
	...
	<p><a href="<?php echo site_url('/wp-content/plugins/obrinfo/rucovodstvo.pdf')?>" title"Руководство пользователя" target="_blank">Руководство пользователя по работе с плагином "Сведения об образовательной организации"</a></p>
	<div class="short">
		<h2>Доступные шорткоды</h2>
		<p>Данные шорткоды должны необходимо разместить на страницах разделов соответственно (один шорткод на одной странице).</p>
		<ul class="codes">
			<li>
				<span class="main">«Сведения об образовательной организации» (основная страница раздела)</span>
				<span class="url">[obr_sveden]</span>
			</li>
			<li>
				<span class="main">«Основные сведения»</span>
				<span class="url">[obr_main]</span>
			</li>
			<li>
				<span class="main">«Структура и органы управления образовательной организацией»</span>
				<span class="url">[obr_struct]</span>
			</li>
			<li>
				<span class="main">«Документы»</span>
				<span class="url">[obr_docs]</span>
			</li>
			<li>
				<span class="main">«Образование»</span>
				<span class="url">[obr_edu]</span>
			</li>
			<li>
				<span class="main">«Образовательные стандарты»</span>
				<span class="url">[obr_stand]</span>
			</li>
			<li>
				<span class="main">«Руководство. Педагогический (научно-педагогический) состав»</span>
				<span class="url">[obr_ped]</span>
			</li>
			<li>
				<span class="main">«Материально-техническое обеспечение и оснащенность образовательного процесса»</span>
				<span class="url">[obr_mto]</span>
			</li>
			<li>
				<span class="main">«Стипендии и иные виды материальной поддержки»</span>
				<span class="url">[obr_stip]</span>
			</li>
			<li>
				<span class="main">«Платные образовательные услуги»</span>
				<span class="url">[obr_paid]</span>
			</li>
			<li>
				<span class="main">«Финансово-хозяйственная деятельность»</span>
				<span class="url">[obr_fhd]</span>
			</li>
			<li>
				<span class="main">«Вакантные места для приема (перевода)»</span>
				<span class="url">[obr_vac]</span>
			</li>
		</ul>
	</div>
	<div class="urls">
		<h2>Адреса страниц (разделов)</h2>
		<p>В соответствии с рекомендациями по формированию адресов страниц раздела «Сведения об образовательной организации».</p>
		<p>Важно! Ссылки оформляются только в таком виде. Нельзя менять написание слов в адресной ссылке.</p>
		<ul>
			<li>
				<span class="main">«Сведения об образовательной организации» (основная страница раздела)</span>
