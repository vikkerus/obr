...
{
	add_menu_page( 'Сведения об Образовательной организации', 'Сведения об ОО', 'manage_options', 'obrinfo', 'obr_menu_page', 'dashicons-format-aside','81.1' );
	add_submenu_page( 'obrinfo','Основные сведения', 'Основные сведения', 'manage_options', 'obrmain', 'obr_main_info' );
	add_submenu_page( 'obrinfo','Структура и органы управления образовательной организацией', 'Структура', 'manage_options', 'obrstruct', 'obr_scructure' );
	add_submenu_page( 'obrinfo','Документы', 'Документы', 'manage_options', 'obrdocs', 'obr_documents' );
	add_submenu_page( 'obrinfo','Образование', 'Образование', 'manage_options', 'obredu', 'obr_education' );
	add_submenu_page( 'obrinfo','Образовательные стандарты', 'Образовательные стандарты', 'manage_options', 'obrstand', 'obr_standart' );
	add_submenu_page( 'obrinfo','Руководство. Педагогический (научно-педагогический) состав', 'Руководство. Педагогический состав', 'manage_options', 'obrped', 'obr_pedagog' );
	add_submenu_page( 'obrinfo','Материально-техническое обеспечение и оснащенность образовательного процесса', 'Материально-техническое обеспечение', 'manage_options', 'obrmat', 'obr_material' );
	add_submenu_page( 'obrinfo','Стипендии и иные виды материальной поддержки', 'Стипендии', 'manage_options', 'obrstip', 'obr_stipend' );
	add_submenu_page( 'obrinfo','Платные образовательные услуги', 'Платные образовательные услуги', 'manage_options', 'obrplat', 'obr_platn' );
	add_submenu_page( 'obrinfo','Финансово-хозяйственная деятельность', 'Финансово-хозяйственная деятельность', 'manage_options', 'obrfhd', 'obr_finance' );
	add_submenu_page( 'obrinfo','Вакантные места для приема (перевода)', 'Вакантные места', 'manage_options', 'obrvac', 'obr_vacancy' );
	add_submenu_page( 'obrinfo','Настройки', 'Настройки', 'manage_options', 'obrset', 'obr_settings' );
}
