		...
		<div class="inputs">
			...
			<?php if(isset($data['restored']['edu']) && is_array($data['restored']['edu'])) : $edu = $data['restored']['edu']; ?>
				...
				<div class="edu_item" id="edu_<?php echo $key?>" name="edu_<?php echo $key?>">
					...
					<div class="input-block input_uploader" id="edu_obr_<?php echo $key?>">
						<label>Информация об описании образовательной программы</label>	
						<input placeholder="Заголовок документа" class="doc_name" type="text" name="edu[<?php echo $key?>][edu_obr_name]" value="<?php echo (isset($val['edu_obr_name']) ? wp_unslash(htmlspecialchars($val['edu_obr_name'])) : '')?>">
						<input class="doc_id block-hidden" type="text" name="edu[<?php echo $key?>][edu_obr_id]" value="<?php echo (isset($val['edu_obr_id']) ? $val['edu_obr_id'] : '')?>">
						<input class="doc_url" readonly="readonly" type="text" name="edu[<?php echo $key?>][edu_obr_url]" value="<?php echo (isset($val['edu_obr_url']) ? $val['edu_obr_url'] : '')?>">
						<a href="javascript:;" class="doc_upload link_btn <?php echo (!empty($val['edu_obr_url']) && !empty($val['edu_obr_id']) ? 'block-hidden' : '')?>">Загрузить документ</a>
						<a href="javascript:;" class="doc_remove link_btn <?php echo (!empty($val['edu_obr_url']) && !empty($val['edu_obr_id']) ? '' : 'block-hidden')?>">Очистить документ</a>
					</div>
					<div class="input-block">
			...
			<div class="edu_item" id="edu_edu_1" name="edu_edu_1">
				...
				<div class="input-block input_uploader" id="edu_obr_1">
					<label>Информация об описании образовательной программы</label>	
					<input placeholder="Заголовок документа" class="doc_name" type="text" name="edu[edu_1][edu_obr_name]" value="">
					<input class="doc_id block-hidden" type="text" name="edu[edu_1][edu_obr_id]" value="">
					<input class="doc_url" readonly="readonly" type="text" name="edu[edu_1][edu_obr_url]" value="">
