...
<div class="page-edu">
	<form name="edu_form" id="edu_form" method="post" action="<?php echo (is_string($data['action']) ? $data['action'] : '')?>">
		...
		<div class="inputs">
            ...
            <div class="inputs">
			<div class="input-block editor-block education_obr">
				<label>Информации о реализуемых образовательных программах, в том числе о реализуемых адаптированных образовательных программах</label>
				<br>
				<div><b>По каждой специальности/образовательной программе должны быть отображены следующие параметры:</b></div>
				<div>Код специальности, направления подготовки;</div>
				<div>Наименование специальности, направления подготовки;</div>
                ...
                <div>Учебные предметы, курсы, дисциплины (модули);</div>
                <div>Использование при реализации образовательных программ электронного обучения и дистанционных образовательных технологий;</div>
                <div>Наличие практики (з.е.) (учебная, производственная, преддипломная практика для выполнения выпускной квалификационной работы);</div>
				<br>
				<?php 
					wp_editor(
						(isset($field['eduobrprog']) ? $field['eduobrprog'] : ''), 
						'eduobrprog', 
						array(
							'wpautop'       => 0,
							'media_buttons' => 1,
							'textarea_name' => 'eduobrprog',
							'tabindex'      => null,
							'textarea_rows' => 10,
							'teeny'         => 0,
							'dfw'           => 0,
