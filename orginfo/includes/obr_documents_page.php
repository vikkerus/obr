			...
			<div class="input-block" id="doc_input_1">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_ust_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_2">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_lic_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_3">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_accr_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_4">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_priem_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_5">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_zan_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_6">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_att_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_7">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_per_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_8">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_voz_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_9">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_stud_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_10">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_ord_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_11">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_col_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_12">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_pom_link']))
							{
								echo $error_msg;
							}
						}
			...
			<div class="input-block" id="doc_input_13">
				<div class="fhd-link">
					...
					<?php 
						...
						{
							if(!obr_check_url($field['docs_paid_link']))
							{
								echo $error_msg;
							}
						}
					...
					<div class="input-block" id="doc_fhd_<?php echo $fkey?>">
						<div class="fhd-link">
							...
							<?php 
								...
								{
									if(!obr_check_url($fval['docs_fhd_link']))
									{
										echo $error_msg;
									}
								}
					...
					<div class="input-block" id="doc_sam_<?php echo $skey?>">
						<div class="fhd-link">
							...
							<?php 
								...
								{
									if(!obr_check_url($sval['docs_sam_link']))
									{
										echo $error_msg;
									}
								}
					...
					<div class="input-block" id="doc_pred_<?php echo $pkey?>">
						<div class="fhd-link">
							...
							<?php 
								...
								{
									if(!obr_check_url($pval['docs_pres_link']))
									{
										echo $error_msg;
									}
								}
					...
					<div class="input-block" id="doc_otch_<?php echo $key?>">
						<div class="fhd-link">
							...
							<?php 
								...
								{
									if(!obr_check_url($val['docs_otch_link']))
									{
										echo $error_msg;
									}
								}
