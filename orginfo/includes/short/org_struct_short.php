...
<div class="org-front structure">
	...
	<div class="panel-group" id="org_struct" role="tablist" aria-multiselectable="true">
		<?php foreach($structs as $key => $val):?>
		<?php if(isset($val['name']) && !empty($val['name'])) :?>
		<div class="panel panel-default">
			<div class="panel-heading" role="tab" id="heading<?php echo $key?>">
				<?php if(isset($val['name']) && !empty($val['name'])) : ?>			
				<a href="javascript:;" data-parent="#org_struct" class="panel-title" role="button" data-toggle="collapse" data-target="#collapse<?php echo $key?>" aria-expanded="false" aria-controls="collapse<?php echo $key?>">
					<?php echo wp_unslash($val['name']);?>
				</a>
				<?php endif;?>
			</div>

			<div id="collapse<?php echo $key?>" class="panel-collapse collapse" aria-labelledby="heading<?php echo $key?>" data-parent="#org_struct" itemprop="structOrgUprav" role="tabpanel">
