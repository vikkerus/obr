...
<div class="org-front edu">
	...
	<div id="org_edu" class="table-responsive">
		<table class="table">
			<thead>
				<tr>
					<th>Код</th>
			...
			<tbody itemprop="eduNir">
				...
				<tr class="signal-line" itemprop="eduOp adeduOp">
					...
					<td>
						<?php if(isset($val['edu_org_id']) && !empty($val['edu_org_id'])) : ?>
							<a itemprop="opMain adOpMain" href="<?php echo (isset($val['edu_org_url']) && !empty($val['edu_org_url'])) ? $val['edu_org_url'] : ''?>" title="Описание образовательной программы" target="_blank"><?php echo (isset($val['edu_org_name']) && !empty($val['edu_org_name'])) ? wp_unslash($val['edu_org_name']) : 'Описание образовательной программы'?></a>
						<?php endif;?>
					</td>
