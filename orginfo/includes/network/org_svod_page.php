<?php $data = org_svod_page();?>

<h2 class="org_title">Отчёт о датах заполнения разделов на сайтах образовательных организаций</h2>

<?php if($file = org_net_csv())
{
...
<?php $number = 1; foreach ($data as $key => $val) : ?>
